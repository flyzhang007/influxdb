...
// returned to the requester as an archive file.  To optionally include a CPU
// profile, the requester should provide a `cpu` query parameter, and can also
// provide a `seconds` parameter to specify a non-default profile collection
// time. The default CPU profile collection time is 30 seconds.
//
